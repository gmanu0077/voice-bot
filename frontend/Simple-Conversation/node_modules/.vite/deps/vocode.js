...
var require_conversation = __commonJS({
  "node_modules/vocode/dist/hooks/conversation.js"(exports) {
    ...
    var useConversation = (config) => {
      ...
      const getStartMessage = (config2, inputAudioMetadata, outputAudioMetadata) => {
        let transcriberConfig = Object.assign(config2.transcriberConfig, inputAudioMetadata);
        ...
        return {
          ...
          transcriberConfig: Object.assign(config2.transcriberConfig, inputAudioMetadata),
          agentConfig: config2.agentConfig,
          synthesizerConfig: Object.assign(config2.synthesizerConfig, outputAudioMetadata),
          conversationId: config2.vocodeConfig.conversationId
        };
      };
      ...
      const startConversation = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        setError(void 0);
        const socket2 = new WebSocket(backendUrl);
        let error2;
        ...
        if ("transcriberConfig" in startMessage) {
          timeSlice = Math.round(1e3 * startMessage.transcriberConfig.chunkSize / startMessage.transcriberConfig.samplingRate);
